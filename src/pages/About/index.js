                ...
                <AboutDetails>
                    ...
                    <div className="about-details">
                        <p className="about-details-paragraph">
                            My name is Hank, and I'm a web developer based in <a href="https://en.wikipedia.org/wiki/Charlotte,_North_Carolina" className="about-link">Charlotte, North Carolina</a>. I specialize in building mobile-first MERN web applications and websites, and love creating products that showcase clean code and engaging user experiences. I am a graduate of <a href="https://en.wikipedia.org/wiki/University_of_North_Carolina_at_Charlotte" className="about-link">the University of North Carolina at Charlotte</a>'s Full Stack Web Development program, and previously worked at <a href="https://www.everyaction.com/" className="about-link">EveryAction</a>, a nonprofit CRM/SaaS company in Washington, DC. Some languages, libraries, and databases that I've been working with recently are:
                        </p>
                    </div>
                    <SkillSet />
                </AboutDetails>
